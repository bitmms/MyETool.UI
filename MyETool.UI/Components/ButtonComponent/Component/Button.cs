...
namespace MyETool.UI.Components.ButtonComponent.Component
{
    public class Button : ButtonBase
    {
        ...
        /// </summary>
        public static readonly DependencyProperty ButtonIconPathProperty = DependencyProperty.Register(
            name: nameof(ButtonIconPath),
            propertyType: typeof(string),
            ownerType: typeof(Button),
            typeMetadata: new PropertyMetadata("pack://application:,,,/MyETool.UI;component/Components/IconComponent/Font/iconfont.ttf#iconfont1")
        );
